...
@section('pageHeader', 'Add Mail Template')
@section('smallPageHeader', '')

@section('breadcrumb')
    <li><a href="#"><i class="fa fa-list"></i> Menu</a></li>
    <li><a href="{{ route('mail.index') }}"> Data Mail Template</a></li>
    <li class="active">Add Mail Template</li>
@endsection
...
<meta name="csrf-token" content="{{ csrf_token() }}">
        <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Add Mail</h3>
                ...
                <div class="box-body">
                    <form role="form" data-toggle="validator" method="POST" class="col-md-6 col-md-offset-3" enctype="multipart/form-data" action="{{ route('mail.store') }}">
                        {{ csrf_field() }}
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email Subject</label>
                                <input type="text" class="form-control" name="template_name" placeholder="Enter Subject" autofocus required>
                            </div>
                            <div class="form-group">
                                <label for="desc">Body</label>
                                <textarea class="desc" name="template" rows="10" cols="80" required></textarea>
                            </div>
                            <div class="form-group">
